...
// Lighting
   ...
   // Responsiveness (https://docs.qmk.fm/#/feature_rgb_matrix?id=additional-configh-options)
   #define RGB_DISABLE_WHEN_USB_SUSPENDED
   #define RGB_MATRIX_MAXIMUM_BRIGHTNESS 127
   
   // Animation modes (https://docs.qmk.fm/#/feature_rgb_matrix?id=rgb-matrix-effects)
